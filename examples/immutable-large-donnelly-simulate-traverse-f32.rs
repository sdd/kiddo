...
type ArchivedTree =
    ArchivedKdTree<f32, usize, Eytzinger, VecOfArenas<f32, usize, 4, BUCKET_SIZE>, 4, BUCKET_SIZE>;

fn main() -> Result<(), Box<dyn Error>> {
    let start = Instant::now();
    let tree_file = File::open("./examples/immutable-ann-test-tree-dy-f32-rkyv_08.rkyv")?;
    ...
    let query_file = File::open("./examples/immutable-ann-test-points-f32-rkyv_08.rkyv")?;
