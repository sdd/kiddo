...
//! the standard [`float::kdtree::KdTree`](`crate::mutable::float::kdtree::KdTree`)
//!
...
//!    this can be twice as long as the default [`float::kdtree::KdTree`](`crate::mutable::float::kdtree::KdTree`).
...
//! or [`f16`](https://docs.rs/half/latest/half/struct.f16.html) in conjunction with the
