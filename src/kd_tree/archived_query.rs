...
use crate::kd_tree::leaf_view_chunked::best_n_within::best_n_within_with_query_wide_arena;
use crate::kd_tree::leaf_view_chunked::nearest_n_within::nearest_n_within_with_query_wide_arena;
use crate::kd_tree::leaf_view_chunked::nearest_one::{
    ...
    rkyv_08::Archived<LS>: LeafStrategy<A, T, SS, K, B>,
{
        ...
        R: ResultCollection<D::Output, NearestNeighbour<D::Output, T>>,
    {
        match <rkyv_08::Archived<LS> as LeafStrategy<A, T, SS, K, B>>::LEAF_PROJECTION {
            ...
            LeafProjection::LeafView => {
                let leaf = self.leaves().leaf_view(leaf_idx);
                crate::kd_tree::leaf_view_chunked::nearest_n_within::nearest_n_within_with_query_wide::<
                    A,
                    T,
                    D,
                    R,
    ...
    rkyv_08::Archived<LS>: LeafStrategy<A, T, SS, K, B>,
{
        ...
        R: BestNeighbourResultCollection<D::Output, T>,
    {
        ...
        match <rkyv_08::Archived<LS> as LeafStrategy<A, T, SS, K, B>>::LEAF_PROJECTION {
            ...
            LeafProjection::LeafView => {
                let leaf = self.leaves().leaf_view(leaf_idx);
                crate::kd_tree::leaf_view_chunked::best_n_within::best_n_within_with_query_wide::<
                    A,
                    T,
                    D,
                    R,
