        ...
        SS::Stack<O>: StackTrait<O, SS>,
    {
        ...
        'query: loop {
            loop {
                ...
                #[cfg(feature = "result_collection_stats")]
                crate::result_collection_stats::record_query_scalar_traverse_step();
                ...
                #[cfg(feature = "result_collection_stats")]
                {
                    ...
                    crate::result_collection_stats::record_query_scalar_rd_off_check(O::cmp(
                        rd_from_off,
                        rd,
                    ));
                }
                ...
                if pivot < A::max_value() {
                    ...
                    if O::cmp(rd_far, query_ctx.max_dist()) != std::cmp::Ordering::Greater {
                        #[cfg(feature = "result_collection_stats")]
                        crate::result_collection_stats::record_query_scalar_far_child_candidate();
                        restore_stack
                        ...
                        #[cfg(feature = "result_collection_stats")]
                        crate::result_collection_stats::record_query_scalar_far_child_reject();
                        restore_stack.push_unchecked_inline(
                            ScalarContinuationRestore::restore_only(old_off),
                        );
                    }
                    #[cfg(feature = "result_collection_stats")]
                    crate::result_collection_stats::record_query_scalar_continuation_frame_push();
                } else {
            ...
            while let Some(frame) = restore_stack.pop() {
                #[cfg(feature = "result_collection_stats")]
                crate::result_collection_stats::record_query_scalar_continuation_frame_pop();
                ...
                #[cfg(feature = "result_collection_stats")]
                crate::result_collection_stats::record_query_scalar_continuation_far_recheck();
                ...
                if should_prune {
                    ...
                    {
                        crate::result_collection_stats::record_query_prune();
                        crate::result_collection_stats::record_query_scalar_continuation_far_reject_after_near();
                    }
                    continue;
                }
                ...
                #[cfg(feature = "result_collection_stats")]
                crate::result_collection_stats::record_query_scalar_continuation_far_enter();
