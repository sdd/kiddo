...
use crate::generate_immutable_dynamic_nearest_one;
use crate::immutable_dynamic::float::kdtree::ImmutableDynamicKdTree;
use crate::nearest_neighbour::NearestNeighbour;
use crate::types::Content;

macro_rules! generate_immutable_dynamic_float_nearest_one {
    ($doctest_build_tree:tt) => {
        generate_immutable_dynamic_nearest_one!((
...
where
    ...
    usize: Cast<T>,
{
    generate_immutable_dynamic_float_nearest_one!(
...
#[cfg(feature = "rkyv")]
impl<A, T, const K: usize, const B: usize> ArchivedImmutableDynamicKdTree<A, T, K, B>
where
...
mod tests {
    ...
    fn can_query_nearest_one_item_f64() {
        ...
        let tree: ImmutableDynamicKdTree<f64, u32, 4, 4> =
    ...
    fn can_query_nearest_one_item_f32() {
        ...
        let tree: ImmutableDynamicKdTree<f32, u32, 4, 4> =
            ImmutableDynamicKdTree::new_from_slice(&content_to_add);
    ...
    fn can_query_nearest_one_item_large_scale_f64() {
        ...
        let tree: ImmutableDynamicKdTree<f64, u32, 4, 256> =
            ImmutableDynamicKdTree::new_from_slice(&content_to_add);
    ...
    fn can_query_nearest_one_item_large_scale_f32() {
        ...
        let tree: ImmutableDynamicKdTree<f32, u32, 4, 256> =
            ImmutableDynamicKdTree::new_from_slice(&content_to_add);
