...
use crate::generate_immutable_dynamic_nearest_n_within;

const MAX_VEC_RESULT_SIZE: usize = 20;

macro_rules! generate_immutable_dynamic_float_nearest_n_within {
    ($doctest_build_tree:tt) => {
        generate_immutable_dynamic_nearest_n_within!((
...
where
    ...
    usize: Cast<T>,
{
    generate_immutable_dynamic_float_nearest_n_within!(
