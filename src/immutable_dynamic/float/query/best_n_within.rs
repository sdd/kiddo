...
use crate::generate_immutable_dynamic_best_n_within;

macro_rules! generate_immutable_dynamic_float_best_n_within {
    ($doctest_build_tree:tt) => {
        generate_immutable_dynamic_best_n_within!(
            (
...
mod tests {
    ...
    fn can_query_best_items_within_radius_large_scale() {
        ...
        let tree: ImmutableDynamicKdTree<AX, i32, 2, 32> =
            ImmutableDynamicKdTree::new_from_slice(&content_to_add);
