...
use crate::dist::{
    Chebyshev, DistanceMetric, DistanceMetricCore, Manhattan, Minkowski, SquaredEuclidean,
};
use crate::Axis;
    ...
    O: Axis<Coord = O>,
{
    ...
    #[inline(always)]
    /// NEON override for exact Block3 mask generation with inherited interval bounds.
