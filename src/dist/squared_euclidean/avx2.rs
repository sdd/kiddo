...
pub struct SquaredEuclideanAvx2F64LeafOps;

impl Avx2F64LeafOps for SquaredEuclideanAvx2F64LeafOps {
    #[inline(always)]
...
pub struct SquaredEuclideanAvx2F32LeafOps;

impl Avx2F32LeafOps for SquaredEuclideanAvx2F32LeafOps {
    #[inline(always)]
    ...
    unsafe fn dist_kn_f32x8(acc: __m256, delta: __m256) -> __m256 {
        _mm256_add_ps(acc, _mm256_mul_ps(delta, delta))
    }
    ...
    unsafe fn dist_kn_f32x4(acc: __m128, delta: __m128) -> __m128 {
        _mm_add_ps(acc, _mm_mul_ps(delta, delta))
    }
