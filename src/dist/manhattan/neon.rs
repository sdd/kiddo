...
pub struct ManhattanNeonF64LeafOps;

impl NeonF64LeafOps for ManhattanNeonF64LeafOps {
    #[inline(always)]
...
pub struct ManhattanNeonF32LeafOps;

impl NeonF32LeafOps for ManhattanNeonF32LeafOps {
    #[inline(always)]
